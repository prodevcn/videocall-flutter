...
class CallSample extends StatefulWidget {
  ...
  @override
  _CallSampleState createState() => new _CallSampleState(serverIP: ip, videoSetting: videoSetting,audioSetting: audioSetting);
}
...
class _CallSampleState extends State<CallSample> {
  ...
  _CallSampleState({Key key, @required this.serverIP,@required this.videoSetting,@required this.audioSetting});
